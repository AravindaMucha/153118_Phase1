...
public class TestClass {
	...
	{
		service.createAccount(null, "9652160279", new BigDecimal(8963));
	}
	...
	{
		service.createAccount("", "9652160279", new BigDecimal(9853));
	}
	...
	{
		service.createAccount("Aravinda", "5632", new BigDecimal(6532));
	}
	...
	{
		service.createAccount("", "", new BigDecimal(1256));
	}
		
	@Test(expected=InvalidInputException.class)
	public void testCreateAccount4() 
	{
		service.createAccount("Aravinda", "", new BigDecimal(5326));
	}
	...
	{
		service.createAccount("Amit", "9900112212", new BigDecimal(-965));
	}
	
	@Test(expected=InvalidInputException.class)
	public void testCreateAccount() 
	{
		service.createAccount("Aravinda", "$2#4@6!8%0", new BigDecimal(-500));
	}

	@Test
	public void testCreateAccount9() 
	{
		Customer actual=service.createAccount("Chinnu", "8008817718", new BigDecimal(0));
		Customer expected=new Customer("Chinnu", "8008817718", new Wallet(new BigDecimal(0)));
	...
	{
		Customer actual=service.createAccount("Mallika", "9177370364", new BigDecimal(5630));
		Customer expected=new Customer("Mallika", "9177370364", new Wallet(new BigDecimal(5260)));
	...
	{
		Customer actual=service.createAccount("SaiPriya", "9652160279", new BigDecimal(5600.75));
		Customer expected=new Customer("SaiPriya", "9652160279", new Wallet(new BigDecimal(5600.75)));
	...
	{
		service.showBalance("9652160279");		
	}
	...
	{
		service.showBalance("9653214569414");		
	}
	...
	{
		service.fundTransfer("8008817718", "9652160279", new BigDecimal(5000));		
	}
